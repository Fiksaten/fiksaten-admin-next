  ...
  return (
    <div className="flex flex-col min-h-screen ">
      ...
      <div className="flex flex-col px-32 py-12 ">
        ...
        <p className="text-center mt-12">15.7.2024 — Fiksaten Group Oy</p>
        <p>
          Tällä asiakirjalla esitetään Fiksaten-palvelun käyttöehdot, jotka
          ...
          omistusoikeutta. Käyttäjä on vastuussa myös, jos Käyttäjän Sisällössä
          on laitonta materiaalia, esimerkiksi lainvastaista vihapuhetta tai
          pornografiaa; tai jos Sisältö on vahingollista tai haitallista
          alaikäisille; tai jos Sisältö rikkoo mitä tahansa lakia tai säännöstä
          tai yllyttää niiden rikkomiseen. Käyttäjä on yksinomaisessa vastuussa
          hallussaan olevien tunnusten ja salasanojen asianmukaisesta
          säilyttämisestä ja vastaavat kaikista toimenpiteistä, mitä tunnuksilla
          ja salasanoilla on tehty Palvelussa taikka tietojensa joutumisesta
          kolmannelle osapuolelle. Fiksaten ei ole missään vastuussa tunnuksilla
          ja salasanoilla tehdyistä mistään toimenpiteistä ja/tai tietojen
          joutumisesta kolmannelle osapuolelle. 3.4 Ostajan oikeudet ja
          velvollisuudet Palvelun varaaminen ja tilaaminen sekä maksaminen tulee
          ...
          mahdolliset palvelumaksut ja / tai verot tällaiseen varaukseen
          liittyvistä muutoksista. Asiakas voi peruuttaa vahvistetun tilauksen
          milloin tahansa noudattaen peruutus käytäntöjä, jolloin Fiksaten
          palauttaa Asiakkaalle Asiakkaan mahdollisesti suorittamat
          palveluhinnat näiden Ehtojen, mahdollisen kotimyyntiasiakirjan,
          noudatettavan lainsäädännön ja peruutus käytäntöjen mukaisesti. Mikäli
          palvelun toimituksen aikana selviää, että Asiakasei ole peruuttanut
          vahvistettua tilausta, eikä Palveluntarjoaja tavoita Asiakasta
          palvelun toimittamiseksi, Asiakason velvollinen maksamaan ehtojen
          vastaisesta peruutuksesta aiheutuneet kulut, vähintään palvelun minimi
          veloituksen. Jos Palveluntarjoaja peruuttaa vahvistetun tilauksen,
          Asiakas saa valita uuden palveluntarjoajan mobiilisovelluksesta. Jos
          Asiakas ei saa uutta Palveluntarjoajaa tai ei halua tilata Palvelua
          uuden Palveluntarjoajan kautta, Asiakas saa täyden hyvityksen
          tällaisen varauksen kokonaiskustannuksista. Mikäli Asiakas peruuttaa
          tilauksen omasta aloitteestaan ilman pätevää perustetta viimeistään 24
          tuntia ennen Palvelun toteuttamista, Mikäli peruuttaminen Asiakkaan
          toimesta tapahtuu alle 24 tuntia ennen Palvelun toteuttamista,
          veloitetaan Asiakkaalta tilauksen kokonaishinnasta 50% sisältäen myös
          Palveluntarjoajan materiaali- ja muut mahdolliset kustannukset. Mikäli
          Palveluntarjoaja peruuttaa Palvelun toimittamisen ennen Palvelun
          toteuttamista, Asiakas on oikeutettu Palveluntarjoajan vaihtamiseen
          tai maksettujen maksujen palautukseen. Sellaisten Palveluiden osalta,
          joissa sääolosuhteet voivat aiheuttaa turvallisuusriskin tai estää
          Palveluntarjoajaa suorittamasta palvelua, Palveluntarjoajalla on
          oikeus peruuttaa Palvelu. Palveluntarjoajat voivat myös peruuttaa
          Palvelun, jos on olemassa muita ehtoja tai työturvallisuuteen
          liittyviä sääntöjä, jotka estäisivät tarjoamasta Palvelua
          turvallisesti. Tällöin Palveluntarjoaja sitoutuu sopimaan Asiakkaan
          kanssa yhdessä uuden päivän, jolloin Palveluntarjoaja voi suorittaa
          Palvelun. Jos Asiakas ja Palveluntarjoaja eivät pääse
          yhteisymmärrykseen uudesta päivästä, voi Asiakas peruuttaa ostonsa ja
          saada maksunsa takaisin tai tapauskohtaisesti Fiksaten voi avustaa
          löytämään vastaavaa Palvelua tarjoavan Palveluntarjoajan. Fiksaten
          Group Oy voi päättää oman harkintakykynsä mukaan varauksen tai
          tilauksen peruuttamisesta, jos Fiksaten perustellun ja vilpittömän
          ...
          palveluista. Fiksaten toimii avuntarve pyyntöjen, tarjousten sekä
          tarpeellisten yhteystietojen välittäjänä, mutta ei tule itse
          osapuoleksi Käyttäjien väliseen Palvelun kautta tai avulla
          syntyneeseen toimeksiantosopimukseen. Fiksatenilla ei ole
          mahdollisuutta eikä velvollisuutta kontrolloida Palvelun kautta
          välitettävien toimeksiantojen ja töiden laatua tai laillisuutta, eikä
          sitä, että sovitut toimeksiannot tulevat asianmukaisesti suoritetuksi
          ja että Asiakas maksaa Palveluntarjoajalle toimeksiannon
          asianmukaisesti. Fiksaten ei takaa, että Palvelussa mukana oleva
          Palveluntarjoaja on rekisteröity ennakkoperintä-, arvonlisävero- tai
          kaupparekisteriin. Ennen tuotteiden ja/tai palveluiden hankkimista on
          syytä tarkistaa Palveluntarjoajan taustat, kuten ennakkoperintä-,
          arvonlisävero- ja kaupparekisteritiedot sekä verovelkatiedot. Fiksaten
          Group Oy ei ole vastuussa Palveluntarjoajan Asiakkaalle tarjoamista
          tuotteista ja/tai palveluista tai heidän tekemistään tahdon
          ilmauksista ja/tai muista sitoumuksista ja/tai sopimuksista taikka
          niiden pätevyydestä. Fiksaten ei ole vastuussa muutoinkaan
          Palveluntarjoajan ja Asiakkaan välisistä asioista. Fiksaten Group
          Oy:llä on oikeus veloittaa Asiakkaalta avuntarve pyyntöistä
          ...
          muutosten, huolto- ja päivitystoimenpiteiden tai vastaavien vuoksi tai
          sulkea tai lakkauttaa Palvelu tarvittaessa jopa ilman
          ennakkovaroitusta, mikäli tähän on erityisiä perusteita. Fiksaten ei
          takaa, että mobiilisovellus toimii keskeytyksettömästi tai
          virheettömästi. Mahdollisista käyttökatkoista ja päivityksistä
          pyritään tiedottamaan Käyttäjiä etukäteen. Fiksaten ei ole vastuussa
          näiden toimenpiteiden tai mahdollisten Palvelun käyttökatkojen tai
          muiden vastaavien häiriöiden Käyttäjille mahdollisesti aiheuttamista
          vahingoista tai menetyksistä. Fiksaten voi tehdä varmuuskopioita
          Palvelusta ja siellä olevasta sisällöstä, mutta valitettavasti
          sisältöä voi hävitä tai sisältö voi muuttua ja siksi on suositeltavaa,
          että Käyttäjät ylläpitävät omaa varmuuskopiota omasta Sisällöstä.
          Fiksaten ei vastaa hävinneestä tai muuttuneesta Sisältöä tai
          vahingosta, joka Käyttäjälle aiheutuu hävinneen tai muuttuneen
          Sisällön johdosta. Fiksaten ei vastaa välittömistä eikä välillisistä
          vahingoista, jotka aiheutuvat Fiksaten mobiilisovelluksesta tai
          Palvelun käytöstä tai käytön estymisestä tai näihin rinnastettavista
          vahingoista. Fiksaten ei vastaa Kolmannen osapuolen Sisältöä,
          kolmannen osapuolen tuottamasta tai julkaisemasta materiaalista, johon
          Fiksaten -mobiilisovellusesta on linkki. Fiksaten -mobiilisovellus,
          omistusoikeus, tekijänoikeus sekä muut immateriaalioikeudet kuuluvat
          Fiksaten Group Oy:lle. Kaikki oikeudet fiksaten.fi ja Fiksaten
          Sisältöön pidätetään. 5. Toimeksiannot ja muu viestiliikenne Käyttäjä
          vastaa sovelluksen kautta antamansa Sisällön oikeellisuudesta ja
          perille saapumisesta. Käyttäjät voivat vapaasti sopia keskenään heidän
          välisensä toimeksiantosopimuksen sisällöstä. Mikäli jo sovittu
          toimeksianto ei osapuolten välillä jostain syystä toteudu tai
          osapuolista jompikumpi rikkoo osapuolten välistä sopimusta,
          Fiksatenilla ei ole velvollisuutta etsiä Käyttäjälle korvaavaa
          sopimuskumppania, korvaavaa tuotetta tai työtä, asennusta, remonttia,
          toimeksiantoa ja/tai muuta palvelua tai korvata sopimusrikkomuksesta
          aiheutunutta haittaa tai vahinkoa. Fiksatenilla on oikeus lähettää
          Palvelun Käyttäjälle sähköpostia sekä ottaa yhteyttä puhelimitse tai
          tekstiviestillä (esim. pyyntö tyytyväisyys arvioon). Käyttäjän tulee
          kaikin kohtuullisin keinoin varmistua siitä, että lähetetty Sisältö ei
          sisällä viruksia tai ole muulla tavoin vahingollista. Avoimessa
          tietoverkossa lähetettyjen sähköpostiviestien luottamuksellisuutta ei
          voida taata. Käyttäjien tulee välttää henkilötietojen tai muiden
          luottamuksellisten viestien välittämistä ylläpidolle sähköpostitse.
          Fiksaten ei vastaa sähköpostiviesteistä aiheutuvista välittömistä tai
          välillisistä vahingoista. Fiksatenilla on oikeus valvoa kaikkia
          Käyttäjien Sisältöjä. Fiksatenilla on oikeus moderoida eli muokata
          Käyttäjien lisäämää ja luomaa sisältöä kuitenkin siten, ettei Sisällön
          keskeinen viesti muutu. Moderointi on oikeutettua kun Fiksaten uskoo
          moderoinnin parantavan Käyttäjien kokemusta Palvelusta tai kun
          Fiksaten uskoo Käyttäjien näin saavan laadukkaampaa Palvelua.
          Käyttäjät voivat pyytää Fiksatenia poistamaan moderoitua Sisältöä
          Palvelusta. Fiksaten voi jättää julkaisematta Käyttäjien Sisältöä,
          Fiksaten voi poistaa Käyttäjien Sisältöä, Fiksaten voi estää Käyttäjän
          pääsyn Palveluun ja Fiksaten voi poistaa Käyttäjän tilin ja profiilin
          Palvelusta, milloin tahansa mistä tahansa syystä tai ilman erillistä
          syytä. Toimeksiantojen ilmoittaminen ilman minkäänlaista aikomusta
          teetättää toimeksiannot Palvelun kautta on kiellettyä. Fiksatenilla on
          oikeus sulkea Käyttäjän tili, mikäli voidaan epäillä Käyttäjän
          toimivan tällä tavoin. Tarjousten pyytäminen töihin, joita tosiasiassa
          ei ole olemassa tai ei ole aikomustakaan teettää, on kielletty.
          Yrittäjät ja yritysten työntekijät eivät saa käyttää Palvelua
          kilpailevien yritysten hintojen tiedusteluun. Fiksatenilla ei ole
          velvollisuutta välittää tai näyttää Käyttäjien avuntarve pyyntöjä,
          tarjouksia tai Sisältöä Palvelussa. Palvelu voi välittää Asiakkaan
          yhteystiedot, avuntarve pyynnön lisätiedot ja muuta Käyttäjän Sisältöä
          Palveluntarjoajalle silloin, kun Palvelun sujuva toiminta sitä vaatii.
          Palveluntarjoaja voi ottaa yhteyttä Asiakkaaseen Palvelun kautta,
          puhelimella ja/tai sähköpostilla. 6. Julkisuus ja yksityisyyden suoja
          Fiksaten käsittelee henkilötietoja henkilötietolain mukaisesti ja
          huolehtii yksityisyyden suojan toteutumisesta henkilötietojen
          käsittelyssä. Rekisteröintiä edellyttävissä palveluissa kerätyt
          käyttäjätiedot ovat osa Fiksatenin asiakasrekisteriä ja niitä
          käytetään vain siinä määriteltyyn tarkoitukseen. Palvelussa olevien
          Palveluntarjoajien profiilit ovat lähtökohtaisesti julkisia ja niiden
          katseleminen on osittain mahdollista ilman Palveluun
          rekisteröitymistäkin. Asiakkaiden profiilien sisältö on siinä määrin
          julkista Palveluntarjoajille, kuin Palvelun toiminta vaatii.
          Palveluntarjoajat voivat tarkastella Asiakkaiden Palvelussa tekemiä
          avuntarve pyyntöjä, jotka sisältävät Asiakkaiden luomaa sisältöä,
          mukaan lukien Asiakkaan nimi, kiinteistön kuva ja avuntarve pyynnön
          muut tiedot. Fiksaten ei ole vastuussa, mikäli Käyttäjän Palveluun
          lisäämät tiedot tulevat kolmansien osapuolien tietoon. Käyttäjän tulee
          huomioida tämä esimerkiksi, mikäli lisää tai linkittää Palvelun
          sivuille henkilökohtaista tai kopiosuojattua tietoa. Fiksaten voi
          kerätä, käsitellä, jakaa, julkaista ja analysoida tietoja Fiksaten
          -mobiilisovelluksen käytöstä, liikenteestä, tapahtumista ja muista
          sivuihin, toimeksiantoihin ja tarjouksiin liittyvistä asioista. 6.1
          Käyttäjätili Rekisteröityessään Palveluun tai aloittaessaan Palvelun
          käytön jättämällä toimeksiannon, Käyttäjän tulee antaa itsestään
          oikeat ja todelliset tiedot. Mikäli tiedoissa tapahtuu muutoksia,
          Käyttäjän tulee päivittää tietonsa. Käyttäjä sitoutuu olemaan luomatta
          Palveluun enempää kuin yhden käyttäjätilin. Mikäli käyttäjä haluaa
          luoda useamman kuin yhden käyttäjätilin, tulee siihen saada
          Fiksatenilta erillinen kirjallinen lupa. Käyttäjätili on
          henkilökohtainen ja Palveluntarjoajien tapauksessa yrityskohtainen.
          Käyttäjä ei saa liittää tiliinsä muiden henkilöiden
          sähköpostiosoitteita, eikä esiintyä toisena henkilönä. Käyttäjä voi
          asettaa itselleen henkilökohtaisen salasanan Palvelun käyttöä varten.
          Salasana on henkilökohtainen ja Palveluntarjoajan tapauksessa
          yrityskohtainen, eikä salasanaa saa luovuttaa muille henkilöille.
          Salasana on pidettävä turvallisessa paikassa. Jos Käyttäjä unohtaa
          salasanan tai salasanaa käytetään väärin, Käyttäjä voi luoda
          Palvelussa uuden salasanan tai ottaa yhteyttä Palvelun
          asiakaspalveluun ja pyytää salasanan käytön estoa ja uuden salasanan
          luontia. Käyttäjä hyväksyy, että Palvelu voi muokata ja lisätä
          Sisältöä käyttäjätiliin ja käyttäjäprofiiliin. Fiksatenilla on lupa
          integroida ja siirtää käyttäjätilejä Fiksatenin omaan muuhun käyttöön
          tiedottamalla rekisteröityneitä käyttäjiä siitä palvelussa.
          Fiksatenilla on oikeus olla hyväksymättä Käyttäjän rekisteröityminen
          sivustolle ja/tai sulkea Käyttäjän tili tarvittaessa, mikäli on
          aihetta epäillä, että kyseinen Käyttäjä käyttää palvelua lain
          vastaisiin tarkoituksiin tai ei noudata Palvelun käyttö- tai
          sopimusehtoja tai niiden henkeä. 6.2 Evästeet ja mainonta Ensimmäisen
          osapuolen evästeet tulevat suoraan siltä verkkosivustolta, jolla käyt.
          Fiksaten -mobiilisovellus käyttää enimmäkseen ensimmäisen osapuolen
          ...
          ottamatta Käyttäjien mahdollisesti Palveluun syöttämiä
          tekijänoikeudella tai muilla immateriaalioikeuksilla suojattuja
          materiaaleja. Sikäli kuin Käyttäjä toimittaa Palveluun Materiaaleja,
          kyseinen Käyttäjä myöntää samalla Fiksatenille oikeuden käyttää
          Materiaalia haluamallaan tavalla toiminnassaan sellaisenaan ja/tai
          muutettuna. Fiksatenilla on siten ei-yksinomainen, siirrettävä,
          ikuinen, peruuttamaton ja maksuton oikeus julkaista, jakaa, levittää,
          käyttää, muunnella, antaa oikeuksia muille ja muutoinkin käyttää
          kaupallisesti ja muutoin haluamallaan tavalla Materiaalia. Fiksaten
          voi lisäksi halutessaan lisätä Materiaaleihin Fiksatenin omia
          tunnuksia Materiaalin yhdistämiseksi Palveluun. Palveluun kuuluvien
          tietojen ja Sisältöjen kopiointi, muokkaaminen, myynti tai muu
          hyväksikäyttäminen ilman Fiksatenin lupaa on kiellettyä. Aineistoa saa
          lainata vain Suomen tekijänoikeuslain (404/1961) mukaisesti. Aineistoa
          lainattaessa on aina ilmoitettava lähde. Sivuihin sisältyviä tavara-
          ja liikemerkkejä ei kuitenkaan saa kopioida, julkaista tai edelleen
          levittää ilman Fiksatenin antamaa kirjallista lupaa. Fiksaten ei
          vastaa Käyttäjälle kolmansien osapuolien immateriaalioikeuksien
          loukkauksista, jotka aiheutuvat siitä, että Palvelua on muutettu tai
