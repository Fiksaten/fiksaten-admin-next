 ...
 * Shhh
 */
export const shhh = <ThrowOnError extends boolean = false>(options?: Options<ShhhData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ShhhResponses, ShhhErrors, ThrowOnError>({
        url: '/shhh',
        ...options,
        headers: {
            'Content-Type': 'application/json',
