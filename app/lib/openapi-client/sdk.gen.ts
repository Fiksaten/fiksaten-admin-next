...
export const getUserNotificationPreferences = <ThrowOnError extends boolean = false>(options?: Options<GetUserNotificationPreferencesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserNotificationPreferencesResponses, GetUserNotificationPreferencesErrors, ThrowOnError>({
...
export const updateUserNotificationPreferences = <ThrowOnError extends boolean = false>(options?: Options<UpdateUserNotificationPreferencesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).patch<UpdateUserNotificationPreferencesResponses, UpdateUserNotificationPreferencesErrors, ThrowOnError>({
        url: '/user/me/notification-preferences',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Disable all notifications for user (opt-out)
 */
export const disableAllNotifications = <ThrowOnError extends boolean = false>(options?: Options<DisableAllNotificationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<DisableAllNotificationsResponses, DisableAllNotificationsErrors, ThrowOnError>({
