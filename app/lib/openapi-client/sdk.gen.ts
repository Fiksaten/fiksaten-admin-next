...
import type { RegisterData, RegisterResponses, RegisterErrors, LoginData, LoginResponses, LoginErrors, RefreshTokenData, RefreshTokenResponses, RefreshTokenErrors, RequestAccountDeletionData, RequestAccountDeletionResponses, RequestAccountDeletionErrors, ForgotPasswordData, ForgotPasswordResponses, ForgotPasswordErrors, ResetPasswordData, ResetPasswordResponses, ResetPasswordErrors, ResetPasswordWithOtpData, ResetPasswordWithOtpResponses, ResetPasswordWithOtpErrors, GetAuthGoogleData, GetAuthGoogleResponses, GetAuthGoogleErrors, GetAuthAppleData, GetAuthAppleResponses, GetAuthAppleErrors, GetAuthOauthCallbackData, GetAuthOauthCallbackResponses, GetAuthOauthCallbackErrors, GetAllCitiesData, GetAllCitiesResponses, GetAllCitiesErrors, GetCityByIdData, GetCityByIdResponses, GetCityByIdErrors, GetCategoriesWithContractorsInCityData, GetCategoriesWithContractorsInCityResponses, GetCategoriesWithContractorsInCityErrors, GetCategoriesWithContractorDetailsInCityData, GetCategoriesWithContractorDetailsInCityResponses, GetCategoriesWithContractorDetailsInCityErrors, GetExpressCategoriesData, GetExpressCategoriesResponses, GetExpressCategoriesErrors, StripeWebhookData, StripeWebhookResponses, StripeWebhookErrors, TicketWebhookData, TicketWebhookResponses, TicketWebhookErrors, CreateAvailableAreaRequestData, CreateAvailableAreaRequestResponses, CreateAvailableAreaRequestErrors, EmailUnsubData, EmailUnsubResponses, EmailUnsubErrors, DeleteCurrentUserData, DeleteCurrentUserResponses, DeleteCurrentUserErrors, GetCurrentUserData, GetCurrentUserResponses, GetCurrentUserErrors, UpdateCurrentUserData, UpdateCurrentUserResponses, UpdateCurrentUserErrors, ContractorJoinRequestData, ContractorJoinRequestResponses, ContractorJoinRequestErrors, GetUserNotificationPermissionsData, GetUserNotificationPermissionsResponses, GetUserNotificationPermissionsErrors, UpdateCurrentUserPermissionsData, UpdateCurrentUserPermissionsResponses, UpdateCurrentUserPermissionsErrors, GetCurrentUserBadgesData, GetCurrentUserBadgesResponses, GetCurrentUserBadgesErrors, UpdateCurrentUserBadgesData, UpdateCurrentUserBadgesResponses, UpdateCurrentUserBadgesErrors, UpdateCurrentUserNotificationTokenData, UpdateCurrentUserNotificationTokenResponses, UpdateCurrentUserNotificationTokenErrors, GetUserAddressesData, GetUserAddressesResponses, GetUserAddressesErrors, CreateUserAddressData, CreateUserAddressResponses, CreateUserAddressErrors, DeleteUserAddressData, DeleteUserAddressResponses, DeleteUserAddressErrors, UpdateUserAddressData, UpdateUserAddressResponses, UpdateUserAddressErrors, SetFavoriteAddressData, SetFavoriteAddressResponses, SetFavoriteAddressErrors, GetUserFavoriteAddressData, GetUserFavoriteAddressResponses, GetUserFavoriteAddressErrors, ValidateUserTokenData, ValidateUserTokenResponses, ValidateUserTokenErrors, GetUserByIdData, GetUserByIdResponses, GetUserByIdErrors, GetSignedUrlData, GetSignedUrlResponses, GetSignedUrlErrors, AddCategoryImageData, AddCategoryImageResponses, AddCategoryImageErrors, GetImagePublicUrlData, GetImagePublicUrlResponses, GetImagePublicUrlErrors, AddOrderImageData, AddOrderImageResponses, AddOrderImageErrors, AddCompanyImageData, AddCompanyImageResponses, AddCompanyImageErrors, AddOrderDoneImageData, AddOrderDoneImageResponses, AddOrderDoneImageErrors, AddPermitImageData, AddPermitImageResponses, AddPermitImageErrors, GetContractorData, GetContractorResponses, GetContractorErrors, GetAvailableContractorsData, GetAvailableContractorsResponses, GetAvailableContractorsErrors, GetIsCurrentUserApprovedAsContractorData, GetIsCurrentUserApprovedAsContractorResponses, GetIsCurrentUserApprovedAsContractorErrors, GetCurrentUserChosenCategoriesData, GetCurrentUserChosenCategoriesResponses, GetCurrentUserChosenCategoriesErrors, ChooseCategoriesAsContractorData, ChooseCategoriesAsContractorResponses, ChooseCategoriesAsContractorErrors, GetContractorMetricsData, GetContractorMetricsResponses, GetContractorMetricsErrors, HideContractorOrderData, HideContractorOrderResponses, HideContractorOrderErrors, GetCurrentContractorDataData, GetCurrentContractorDataResponses, GetCurrentContractorDataErrors, UpdateCurrentContractorDataData, UpdateCurrentContractorDataResponses, UpdateCurrentContractorDataErrors, GetCurrentContractorOrdersData, GetCurrentContractorOrdersResponses, GetCurrentContractorOrdersErrors, GetCurrentContractorReviewsData, GetCurrentContractorReviewsResponses, GetCurrentContractorReviewsErrors, GetOpenRequestsForContractorData, GetOpenRequestsForContractorResponses, GetOpenRequestsForContractorErrors, GetContractorSentRequestsData, GetContractorSentRequestsResponses, GetContractorSentRequestsErrors, GetContractorHistoryRequestsData, GetContractorHistoryRequestsResponses, GetContractorHistoryRequestsErrors, GetContractorInProgressRequestsData, GetContractorInProgressRequestsResponses, GetContractorInProgressRequestsErrors, ChooseCitiesAsContractorData, ChooseCitiesAsContractorResponses, ChooseCitiesAsContractorErrors, GetContractorCitiesData, GetContractorCitiesResponses, GetContractorCitiesErrors, GetContractorByOrderIdData, GetContractorByOrderIdResponses, GetContractorByOrderIdErrors, GetContractorAnalyticsData, GetContractorAnalyticsResponses, GetContractorAnalyticsErrors, GetContractorChartDataData, GetContractorChartDataResponses, GetContractorChartDataErrors, GetContractorPerformanceTrendsData, GetContractorPerformanceTrendsResponses, GetContractorPerformanceTrendsErrors, GetOwnOrdersData, GetOwnOrdersResponses, GetOwnOrdersErrors, CreateOrderData, CreateOrderResponses, CreateOrderErrors, RemoveOrderData, RemoveOrderResponses, RemoveOrderErrors, GetOrderDetailsData, GetOrderDetailsResponses, GetOrderDetailsErrors, UpdateOrderData, UpdateOrderResponses, UpdateOrderErrors, RemoveDraftData, RemoveDraftResponses, RemoveDraftErrors, GetOwnDraftOrdersData, GetOwnDraftOrdersResponses, GetOwnDraftOrdersErrors, GetOrderImagesData, GetOrderImagesResponses, GetOrderImagesErrors, GetOffersToOrderData, GetOffersToOrderResponses, GetOffersToOrderErrors, AcceptOfferData, AcceptOfferResponses, AcceptOfferErrors, AskMoreInfoData, AskMoreInfoResponses, AskMoreInfoErrors, CreateExpressOrderData, CreateExpressOrderResponses, CreateExpressOrderErrors, GetExpressOrderOptionsData, GetExpressOrderOptionsResponses, GetExpressOrderOptionsErrors, GetOwnExpressOrdersData, GetOwnExpressOrdersResponses, GetOwnExpressOrdersErrors, SearchExpressOrdersData, SearchExpressOrdersResponses, SearchExpressOrdersErrors, AcceptExpressOrderData, AcceptExpressOrderResponses, AcceptExpressOrderErrors, CompleteOrderData, CompleteOrderResponses, CompleteOrderErrors, CompleteExpressOrderData, CompleteExpressOrderResponses, CompleteExpressOrderErrors, GetExpressOrderDetailsData, GetExpressOrderDetailsResponses, GetExpressOrderDetailsErrors, GetExpressOrdersByUserIdData, GetExpressOrdersByUserIdResponses, GetExpressOrdersByUserIdErrors, GetOrdersByUserIdData, GetOrdersByUserIdResponses, GetOrdersByUserIdErrors, RemoveExpressOrderData, RemoveExpressOrderResponses, RemoveExpressOrderErrors, CreateCampaignOrderData, CreateCampaignOrderResponses, CreateCampaignOrderErrors, GetCampaignOrderDetailsData, GetCampaignOrderDetailsResponses, GetCampaignOrderDetailsErrors, GetOwnCampaignOrdersData, GetOwnCampaignOrdersResponses, GetOwnCampaignOrdersErrors, GetExpressOrdersWhereContractorData, GetExpressOrdersWhereContractorResponses, GetExpressOrdersWhereContractorErrors, GetOfferToOrderDetailsData, GetOfferToOrderDetailsResponses, GetOfferToOrderDetailsErrors, GetCustomerServiceTicketsData, GetCustomerServiceTicketsResponses, GetCustomerServiceTicketsErrors, CreateCustomerServiceTicketData, CreateCustomerServiceTicketResponses, CreateCustomerServiceTicketErrors, GetCustomerServiceTicketData, GetCustomerServiceTicketResponses, GetCustomerServiceTicketErrors, AddCustomerServiceTicketMessageData, AddCustomerServiceTicketMessageResponses, AddCustomerServiceTicketMessageErrors, UpdateCustomerServiceTicketData, UpdateCustomerServiceTicketResponses, UpdateCustomerServiceTicketErrors, GetCustomerServiceTicketsAdminData, GetCustomerServiceTicketsAdminResponses, GetCustomerServiceTicketsAdminErrors, AssignCustomerServiceTicketData, AssignCustomerServiceTicketResponses, AssignCustomerServiceTicketErrors, UpdateCustomerServiceTicketStatusData, UpdateCustomerServiceTicketStatusResponses, UpdateCustomerServiceTicketStatusErrors, AdminRespondToTicketData, AdminRespondToTicketResponses, AdminRespondToTicketErrors, GetTicketAiSuggestionsData, GetTicketAiSuggestionsResponses, GetTicketAiSuggestionsErrors, AcceptTicketAiSuggestionData, AcceptTicketAiSuggestionResponses, AcceptTicketAiSuggestionErrors, DismissTicketAiSuggestionData, DismissTicketAiSuggestionResponses, DismissTicketAiSuggestionErrors, ApplyTicketAiSuggestionData, ApplyTicketAiSuggestionResponses, ApplyTicketAiSuggestionErrors, UpdateCustomerServiceTicketCategoryData, UpdateCustomerServiceTicketCategoryResponses, UpdateCustomerServiceTicketCategoryErrors, UpdateCustomerServiceTicketPriorityData, UpdateCustomerServiceTicketPriorityResponses, UpdateCustomerServiceTicketPriorityErrors, GetNotificationsData, GetNotificationsResponses, GetNotificationsErrors, MarkNotificationReadData, MarkNotificationReadResponses, MarkNotificationReadErrors, MarkAllNotificationsReadData, MarkAllNotificationsReadResponses, MarkAllNotificationsReadErrors, GetAllOrderMoreInfoRequestsData, GetAllOrderMoreInfoRequestsResponses, GetAllOrderMoreInfoRequestsErrors, GetOrderMoreInfoRequestData, GetOrderMoreInfoRequestResponses, GetOrderMoreInfoRequestErrors, RespondOrderMoreInfoRequestData, RespondOrderMoreInfoRequestResponses, RespondOrderMoreInfoRequestErrors, AddCategoryData, AddCategoryResponses, AddCategoryErrors, AcceptReviewData, AcceptReviewResponses, AcceptReviewErrors, DeclineReviewData, DeclineReviewResponses, DeclineReviewErrors, ApproveContractorData, ApproveContractorResponses, ApproveContractorErrors, DeclineContractorData, DeclineContractorResponses, DeclineContractorErrors, DeleteCategoryData, DeleteCategoryResponses, DeleteCategoryErrors, GetAllReviewsData, GetAllReviewsResponses, GetAllReviewsErrors, GetAllContractorJoinRequestsData, GetAllContractorJoinRequestsResponses, GetAllContractorJoinRequestsErrors, GetAllUsersData, GetAllUsersResponses, GetAllUsersErrors, GetDeletedUsersData, GetDeletedUsersResponses, GetDeletedUsersErrors, GetAdminAnalyticsData, GetAdminAnalyticsResponses, GetAdminAnalyticsErrors, SendCustomNotificationToUserData, SendCustomNotificationToUserResponses, SendCustomNotificationToUserErrors, SendCustomNotificationToAllUsersData, SendCustomNotificationToAllUsersResponses, SendCustomNotificationToAllUsersErrors, SendCustomNotificationToAllConsumersData, SendCustomNotificationToAllConsumersResponses, SendCustomNotificationToAllConsumersErrors, SendCustomNotificationToAllContractorsData, SendCustomNotificationToAllContractorsResponses, SendCustomNotificationToAllContractorsErrors, UpdateCategoryData, UpdateCategoryResponses, UpdateCategoryErrors, GetAllCampaignsData, GetAllCampaignsResponses, GetAllCampaignsErrors, CreateCampaignData, CreateCampaignResponses, CreateCampaignErrors, DeleteCampaignData, DeleteCampaignResponses, DeleteCampaignErrors, UpdateCampaignData, UpdateCampaignResponses, UpdateCampaignErrors, GetAllCampaignOrdersData, GetAllCampaignOrdersResponses, GetAllCampaignOrdersErrors, UpdateCampaignOrderData, UpdateCampaignOrderResponses, UpdateCampaignOrderErrors, GetInterestedContractorsData, GetInterestedContractorsResponses, GetInterestedContractorsErrors, CreateInterestedContractorData, CreateInterestedContractorResponses, CreateInterestedContractorErrors, DeleteInterestedContractorData, DeleteInterestedContractorResponses, DeleteInterestedContractorErrors, UpdateInterestedContractorData, UpdateInterestedContractorResponses, UpdateInterestedContractorErrors, SendWelcomeEmailsToContractorsData, SendWelcomeEmailsToContractorsResponses, SendWelcomeEmailsToContractorsErrors, PostRetryFailedEmailsData, PostRetryFailedEmailsResponses, PostRetryFailedEmailsErrors, PostByIdRetryWelcomeEmailData, PostByIdRetryWelcomeEmailResponses, PostByIdRetryWelcomeEmailErrors, GetContractorStatsData, GetContractorStatsResponses, GetContractorStatsErrors, GetAllOrdersData, GetAllOrdersResponses, GetAllOrdersErrors, GetAdminOrderDetailsData, GetAdminOrderDetailsResponses, GetAdminOrderDetailsErrors, GetAdminExpressOrderDetailsData, GetAdminExpressOrderDetailsResponses, GetAdminExpressOrderDetailsErrors, GetAdminCampaignOrderDetailsData, GetAdminCampaignOrderDetailsResponses, GetAdminCampaignOrderDetailsErrors, GetAllAdminsData, GetAllAdminsResponses, GetAllAdminsErrors, GetUsersInsightsData, GetUsersInsightsResponses, GetUsersInsightsErrors, GetAdminNotificationsInsightsData, GetAdminNotificationsInsightsResponses, GetAdminNotificationsInsightsErrors, GetAllContractorsData, GetAllContractorsResponses, GetAllContractorsErrors, GetContractorDetailsData, GetContractorDetailsResponses, GetContractorDetailsErrors, GetAllAvailableAreaRequestsData, GetAllAvailableAreaRequestsResponses, GetAllAvailableAreaRequestsErrors, GetCategoriesData, GetCategoriesResponses, GetCategoriesErrors, GetAvailableCategoriesData, GetAvailableCategoriesResponses, GetAvailableCategoriesErrors, GetExpressCategoryQuestionsData, GetExpressCategoryQuestionsResponses, GetExpressCategoryQuestionsErrors, GetCitiesWithContractorsForCategoryData, GetCitiesWithContractorsForCategoryResponses, GetCitiesWithContractorsForCategoryErrors, GetCitiesWithContractorDetailsForCategoryData, GetCitiesWithContractorDetailsForCategoryResponses, GetCitiesWithContractorDetailsForCategoryErrors, GetReviewsForContractorData, GetReviewsForContractorResponses, GetReviewsForContractorErrors, AddNewReviewForContractorData, AddNewReviewForContractorResponses, AddNewReviewForContractorErrors, CreatePaymentIntentData, CreatePaymentIntentResponses, CreatePaymentIntentErrors, CreateExpressPaymentIntentData, CreateExpressPaymentIntentResponses, CreateExpressPaymentIntentErrors, CreateStripeAccountLinkData, CreateStripeAccountLinkResponses, CreateStripeAccountLinkErrors, GetUpdateStripeAccountDetailsLinkData, GetUpdateStripeAccountDetailsLinkResponses, GetUpdateStripeAccountDetailsLinkErrors, CancelOfferData, CancelOfferResponses, CancelOfferErrors, CreateOfferData, CreateOfferResponses, CreateOfferErrors, GetPublicCampaignsData, GetPublicCampaignsResponses, GetPublicCampaignsErrors } from './types.gen';
 ...
 */
export const resetPasswordWithOtp = <ThrowOnError extends boolean = false>(options: Options<ResetPasswordWithOtpData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResetPasswordWithOtpResponses, ResetPasswordWithOtpErrors, ThrowOnError>({
...
/**
 * Get categories with contractors in a specific city
 * Returns a list of categories that have contractors available in the specified city
 */
export const getCategoriesWithContractorsInCity = <ThrowOnError extends boolean = false>(options: Options<GetCategoriesWithContractorsInCityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCategoriesWithContractorsInCityResponses, GetCategoriesWithContractorsInCityErrors, ThrowOnError>({
...
/**
 * Get categories with contractor details in a specific city
 * Returns a list of categories with detailed contractor information in the specified city
 */
export const getCategoriesWithContractorDetailsInCity = <ThrowOnError extends boolean = false>(options: Options<GetCategoriesWithContractorDetailsInCityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCategoriesWithContractorDetailsInCityResponses, GetCategoriesWithContractorDetailsInCityErrors, ThrowOnError>({
...
/**
 * Ticket webhook
 * Ticket webhook with Agentuity agent integration
 */
export const ticketWebhook = <ThrowOnError extends boolean = false>(options?: Options<TicketWebhookData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<TicketWebhookResponses, TicketWebhookErrors, ThrowOnError>({
 ...
 * Email Unsub
 */
export const emailUnsub = <ThrowOnError extends boolean = false>(options?: Options<EmailUnsubData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<EmailUnsubResponses, EmailUnsubErrors, ThrowOnError>({
        url: '/email-unsub',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Delete current user
 * Marks current user as deleted and removes auth
 */
export const deleteCurrentUser = <ThrowOnError extends boolean = false>(options?: Options<DeleteCurrentUserData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteCurrentUserResponses, DeleteCurrentUserErrors, ThrowOnError>({
        url: '/users/me',
        ...options
    });
};
...
/**
 * Add category image
 * Add category image to the database
 */
export const addCategoryImage = <ThrowOnError extends boolean = false>(options: Options<AddCategoryImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddCategoryImageResponses, AddCategoryImageErrors, ThrowOnError>({
 ...
 * Get image public url
 */
export const getImagePublicUrl = <ThrowOnError extends boolean = false>(options: Options<GetImagePublicUrlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetImagePublicUrlResponses, GetImagePublicUrlErrors, ThrowOnError>({
        url: '/images/{imageKey}',
        ...options
    });
};
...
/**
 * Add order image
 * Add order image to the database
 */
export const addOrderImage = <ThrowOnError extends boolean = false>(options: Options<AddOrderImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddOrderImageResponses, AddOrderImageErrors, ThrowOnError>({
...
/**
 * Add company image
 * Add company image to the database
 */
export const addCompanyImage = <ThrowOnError extends boolean = false>(options: Options<AddCompanyImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddCompanyImageResponses, AddCompanyImageErrors, ThrowOnError>({
...
/**
 * Add order done image
 * Add order done image to the database
 */
export const addOrderDoneImage = <ThrowOnError extends boolean = false>(options: Options<AddOrderDoneImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddOrderDoneImageResponses, AddOrderDoneImageErrors, ThrowOnError>({
...
/**
 * Add permit image
 * Add permit image to the database
 */
export const addPermitImage = <ThrowOnError extends boolean = false>(options: Options<AddPermitImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddPermitImageResponses, AddPermitImageErrors, ThrowOnError>({
...
/**
 * Get contractor analytics snapshot
 * Retrieve latest analytics snapshot for contractors
 */
export const getContractorAnalytics = <ThrowOnError extends boolean = false>(options?: Options<GetContractorAnalyticsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetContractorAnalyticsResponses, GetContractorAnalyticsErrors, ThrowOnError>({
...
/**
 * Get contractor chart data
 * Get contractor chart data for revenue and projects
 */
export const getContractorChartData = <ThrowOnError extends boolean = false>(options?: Options<GetContractorChartDataData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetContractorChartDataResponses, GetContractorChartDataErrors, ThrowOnError>({
...
/**
 * Get contractor performance trends
 * Get contractor performance trends for acceptance rate and ratings
 */
export const getContractorPerformanceTrends = <ThrowOnError extends boolean = false>(options?: Options<GetContractorPerformanceTrendsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetContractorPerformanceTrendsResponses, GetContractorPerformanceTrendsErrors, ThrowOnError>({
...
/**
 * Remove an express order
 * Remove an express order
 */
export const removeExpressOrder = <ThrowOnError extends boolean = false>(options: Options<RemoveExpressOrderData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<RemoveExpressOrderResponses, RemoveExpressOrderErrors, ThrowOnError>({
 ...
 * Create a campaign order
 */
export const createCampaignOrder = <ThrowOnError extends boolean = false>(options?: Options<CreateCampaignOrderData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateCampaignOrderResponses, CreateCampaignOrderErrors, ThrowOnError>({
        url: '/orders/campaign',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Get a campaign order details
 * Get a campaign order details
 */
export const getCampaignOrderDetails = <ThrowOnError extends boolean = false>(options: Options<GetCampaignOrderDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCampaignOrderDetailsResponses, GetCampaignOrderDetailsErrors, ThrowOnError>({
...
/**
 * Get all campaign orders for the user
 * Get all campaign orders for the user
 */
export const getOwnCampaignOrders = <ThrowOnError extends boolean = false>(options?: Options<GetOwnCampaignOrdersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetOwnCampaignOrdersResponses, GetOwnCampaignOrdersErrors, ThrowOnError>({
...
/**
 * Get express orders where current user is marked as contractor
 * Get express orders where current user is marked as contractor
 */
export const getExpressOrdersWhereContractor = <ThrowOnError extends boolean = false>(options?: Options<GetExpressOrdersWhereContractorData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetExpressOrdersWhereContractorResponses, GetExpressOrdersWhereContractorErrors, ThrowOnError>({
...
/**
 * Get offer to order details
 * Get offer to order details
 */
export const getOfferToOrderDetails = <ThrowOnError extends boolean = false>(options: Options<GetOfferToOrderDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetOfferToOrderDetailsResponses, GetOfferToOrderDetailsErrors, ThrowOnError>({
...
/**
 * Get tickets for user with pagination and timezone conversion
 */
...
/**
 * Get ticket with full conversation thread and timezone handling
 */
...
/**
 * Get all tickets with advanced filtering (Admin only)
 */
export const getCustomerServiceTicketsAdmin = <ThrowOnError extends boolean = false>(options?: Options<GetCustomerServiceTicketsAdminData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetCustomerServiceTicketsAdminResponses, GetCustomerServiceTicketsAdminErrors, ThrowOnError>({
 ...
 */
export const assignCustomerServiceTicket = <ThrowOnError extends boolean = false>(options: Options<AssignCustomerServiceTicketData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<AssignCustomerServiceTicketResponses, AssignCustomerServiceTicketErrors, ThrowOnError>({
 ...
 */
export const updateCustomerServiceTicketStatus = <ThrowOnError extends boolean = false>(options: Options<UpdateCustomerServiceTicketStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateCustomerServiceTicketStatusResponses, UpdateCustomerServiceTicketStatusErrors, ThrowOnError>({
...
/**
 * Admin response to ticket with proper user identification
 */
export const adminRespondToTicket = <ThrowOnError extends boolean = false>(options: Options<AdminRespondToTicketData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AdminRespondToTicketResponses, AdminRespondToTicketErrors, ThrowOnError>({
 ...
 */
export const getTicketAiSuggestions = <ThrowOnError extends boolean = false>(options: Options<GetTicketAiSuggestionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTicketAiSuggestionsResponses, GetTicketAiSuggestionsErrors, ThrowOnError>({
 ...
 */
export const acceptTicketAiSuggestion = <ThrowOnError extends boolean = false>(options: Options<AcceptTicketAiSuggestionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AcceptTicketAiSuggestionResponses, AcceptTicketAiSuggestionErrors, ThrowOnError>({
 ...
 */
export const dismissTicketAiSuggestion = <ThrowOnError extends boolean = false>(options: Options<DismissTicketAiSuggestionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<DismissTicketAiSuggestionResponses, DismissTicketAiSuggestionErrors, ThrowOnError>({
...
/**
 * Apply an AI suggestion to the ticket
 */
export const applyTicketAiSuggestion = <ThrowOnError extends boolean = false>(options: Options<ApplyTicketAiSuggestionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApplyTicketAiSuggestionResponses, ApplyTicketAiSuggestionErrors, ThrowOnError>({
...
/**
 * Create customer service ticket category
 */
export const updateCustomerServiceTicketCategory = <ThrowOnError extends boolean = false>(options: Options<UpdateCustomerServiceTicketCategoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateCustomerServiceTicketCategoryResponses, UpdateCustomerServiceTicketCategoryErrors, ThrowOnError>({
...
/**
 * Update customer service ticket priority
 */
export const updateCustomerServiceTicketPriority = <ThrowOnError extends boolean = false>(options: Options<UpdateCustomerServiceTicketPriorityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateCustomerServiceTicketPriorityResponses, UpdateCustomerServiceTicketPriorityErrors, ThrowOnError>({
...
/**
 * Get deleted users
 * List deleted users and their status
 */
export const getDeletedUsers = <ThrowOnError extends boolean = false>(options?: Options<GetDeletedUsersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDeletedUsersResponses, GetDeletedUsersErrors, ThrowOnError>({
 ...
 * Retrieve latest analytics snapshot for admins including trends and projections
 */
export const getAdminAnalytics = <ThrowOnError extends boolean = false>(options?: Options<GetAdminAnalyticsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAdminAnalyticsResponses, GetAdminAnalyticsErrors, ThrowOnError>({
        url: '/admin/analytics',
        ...options
    });
};
 ...
 */
export const sendCustomNotificationToUser = <ThrowOnError extends boolean = false>(options?: Options<SendCustomNotificationToUserData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SendCustomNotificationToUserResponses, SendCustomNotificationToUserErrors, ThrowOnError>({
 ...
 */
export const sendCustomNotificationToAllUsers = <ThrowOnError extends boolean = false>(options?: Options<SendCustomNotificationToAllUsersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SendCustomNotificationToAllUsersResponses, SendCustomNotificationToAllUsersErrors, ThrowOnError>({
...
/**
 * Send custom notification to all consumers
 */
export const sendCustomNotificationToAllConsumers = <ThrowOnError extends boolean = false>(options?: Options<SendCustomNotificationToAllConsumersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SendCustomNotificationToAllConsumersResponses, SendCustomNotificationToAllConsumersErrors, ThrowOnError>({
...
/**
 * Send custom notification to all contractors
 */
export const sendCustomNotificationToAllContractors = <ThrowOnError extends boolean = false>(options?: Options<SendCustomNotificationToAllContractorsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SendCustomNotificationToAllContractorsResponses, SendCustomNotificationToAllContractorsErrors, ThrowOnError>({
 ...
 * Get all campaigns
 */
export const getAllCampaigns = <ThrowOnError extends boolean = false>(options?: Options<GetAllCampaignsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllCampaignsResponses, GetAllCampaignsErrors, ThrowOnError>({
        url: '/admin/campaigns',
        ...options
    });
};
...
export const createCampaign = <ThrowOnError extends boolean = false>(options?: Options<CreateCampaignData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateCampaignResponses, CreateCampaignErrors, ThrowOnError>({
        url: '/admin/campaigns',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const deleteCampaign = <ThrowOnError extends boolean = false>(options: Options<DeleteCampaignData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteCampaignResponses, DeleteCampaignErrors, ThrowOnError>({
...
export const updateCampaign = <ThrowOnError extends boolean = false>(options: Options<UpdateCampaignData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateCampaignResponses, UpdateCampaignErrors, ThrowOnError>({
        url: '/admin/campaigns/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Get all campaign orders for admin management
 */
export const getAllCampaignOrders = <ThrowOnError extends boolean = false>(options?: Options<GetAllCampaignOrdersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllCampaignOrdersResponses, GetAllCampaignOrdersErrors, ThrowOnError>({
 ...
 * Update campaign order status and scheduling
 */
export const updateCampaignOrder = <ThrowOnError extends boolean = false>(options: Options<UpdateCampaignOrderData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateCampaignOrderResponses, UpdateCampaignOrderErrors, ThrowOnError>({
...
/**
 * Get all interested contractors
 * Get paginated list of interested contractors with filtering options
 */
export const getInterestedContractors = <ThrowOnError extends boolean = false>(options?: Options<GetInterestedContractorsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetInterestedContractorsResponses, GetInterestedContractorsErrors, ThrowOnError>({
...
/**
 * Create new interested contractor
 * Add a new interested contractor to the system
 */
export const createInterestedContractor = <ThrowOnError extends boolean = false>(options?: Options<CreateInterestedContractorData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateInterestedContractorResponses, CreateInterestedContractorErrors, ThrowOnError>({
        url: '/admin/interested-contractors',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Delete interested contractor
 * Delete an interested contractor from the system
 */
export const deleteInterestedContractor = <ThrowOnError extends boolean = false>(options: Options<DeleteInterestedContractorData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteInterestedContractorResponses, DeleteInterestedContractorErrors, ThrowOnError>({
...
/**
 * Update interested contractor
 * Update an existing interested contractor's information
 */
export const updateInterestedContractor = <ThrowOnError extends boolean = false>(options: Options<UpdateInterestedContractorData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateInterestedContractorResponses, UpdateInterestedContractorErrors, ThrowOnError>({
        url: '/admin/interested-contractors/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Send welcome emails to contractors
 * Send welcome emails to all contractors who haven't received them yet, or to specific contractors if IDs are provided
 */
export const sendWelcomeEmailsToContractors = <ThrowOnError extends boolean = false>(options?: Options<SendWelcomeEmailsToContractorsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SendWelcomeEmailsToContractorsResponses, SendWelcomeEmailsToContractorsErrors, ThrowOnError>({
 ...
 * Retry sending welcome emails to contractors who had previous failed attempts
 */
export const postRetryFailedEmails = <ThrowOnError extends boolean = false>(options?: Options<PostRetryFailedEmailsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostRetryFailedEmailsResponses, PostRetryFailedEmailsErrors, ThrowOnError>({
...
/**
 * Retry welcome email for specific contractor
 * Retry sending welcome email to a specific contractor who had a previous failed attempt
 */
export const postByIdRetryWelcomeEmail = <ThrowOnError extends boolean = false>(options: Options<PostByIdRetryWelcomeEmailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostByIdRetryWelcomeEmailResponses, PostByIdRetryWelcomeEmailErrors, ThrowOnError>({
 ...
 * Get aggregated statistics for interested contractors
 */
export const getContractorStats = <ThrowOnError extends boolean = false>(options?: Options<GetContractorStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetContractorStatsResponses, GetContractorStatsErrors, ThrowOnError>({
...
/**
 * Get all orders for the admin including express orders, campaign orders, and normal orders with pagination
 * Get all orders for the admin with pagination support
 */
export const getAllOrders = <ThrowOnError extends boolean = false>(options?: Options<GetAllOrdersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllOrdersResponses, GetAllOrdersErrors, ThrowOnError>({
 ...
 * Get order details for admin (bypasses user permission checks)
 */
export const getAdminOrderDetails = <ThrowOnError extends boolean = false>(options: Options<GetAdminOrderDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAdminOrderDetailsResponses, GetAdminOrderDetailsErrors, ThrowOnError>({
...
/**
 * Get express order details for admin
 * Get express order details for admin (bypasses user permission checks)
 */
export const getAdminExpressOrderDetails = <ThrowOnError extends boolean = false>(options: Options<GetAdminExpressOrderDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAdminExpressOrderDetailsResponses, GetAdminExpressOrderDetailsErrors, ThrowOnError>({
...
/**
 * Get campaign order details for admin
 * Get campaign order details for admin (bypasses user permission checks)
 */
export const getAdminCampaignOrderDetails = <ThrowOnError extends boolean = false>(options: Options<GetAdminCampaignOrderDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAdminCampaignOrderDetailsResponses, GetAdminCampaignOrderDetailsErrors, ThrowOnError>({
...
export const getAllAdmins = <ThrowOnError extends boolean = false>(options?: Options<GetAllAdminsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllAdminsResponses, GetAllAdminsErrors, ThrowOnError>({
...
/**
 * Get users insights for admin
 */
export const getUsersInsights = <ThrowOnError extends boolean = false>(options?: Options<GetUsersInsightsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUsersInsightsResponses, GetUsersInsightsErrors, ThrowOnError>({
...
/**
 * Get notifications insights for admin
 */
export const getAdminNotificationsInsights = <ThrowOnError extends boolean = false>(options?: Options<GetAdminNotificationsInsightsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAdminNotificationsInsightsResponses, GetAdminNotificationsInsightsErrors, ThrowOnError>({
 ...
 * Get all contractors
 */
export const getAllContractors = <ThrowOnError extends boolean = false>(options?: Options<GetAllContractorsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllContractorsResponses, GetAllContractorsErrors, ThrowOnError>({
 ...
 * Get contractor details
 */
export const getContractorDetails = <ThrowOnError extends boolean = false>(options: Options<GetContractorDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetContractorDetailsResponses, GetContractorDetailsErrors, ThrowOnError>({
...
/**
 * Get all available area requests
 * Get all available area requests for admin management
 */
export const getAllAvailableAreaRequests = <ThrowOnError extends boolean = false>(options?: Options<GetAllAvailableAreaRequestsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllAvailableAreaRequestsResponses, GetAllAvailableAreaRequestsErrors, ThrowOnError>({
...
/**
 * Get express category questions
 * Get express category questions
 */
export const getExpressCategoryQuestions = <ThrowOnError extends boolean = false>(options: Options<GetExpressCategoryQuestionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetExpressCategoryQuestionsResponses, GetExpressCategoryQuestionsErrors, ThrowOnError>({
...
/**
 * Get cities with contractors for a specific category
 * Returns a list of cities that have contractors available for the specified category
 */
export const getCitiesWithContractorsForCategory = <ThrowOnError extends boolean = false>(options: Options<GetCitiesWithContractorsForCategoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCitiesWithContractorsForCategoryResponses, GetCitiesWithContractorsForCategoryErrors, ThrowOnError>({
...
/**
 * Get cities with contractor details for a specific category
 * Returns a list of cities with detailed contractor information for the specified category
 */
export const getCitiesWithContractorDetailsForCategory = <ThrowOnError extends boolean = false>(options: Options<GetCitiesWithContractorDetailsForCategoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCitiesWithContractorDetailsForCategoryResponses, GetCitiesWithContractorDetailsForCategoryErrors, ThrowOnError>({
 ...
 */
export const getPublicCampaigns = <ThrowOnError extends boolean = false>(options?: Options<GetPublicCampaignsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetPublicCampaignsResponses, GetPublicCampaignsErrors, ThrowOnError>({
        url: '/campaigns',
        ...options
    });
};