 ...
 * Send welcome emails to all contractors who haven't received them yet
 */
export const postSendWelcomeEmails = <ThrowOnError extends boolean = false>(options?: Options<PostSendWelcomeEmailsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostSendWelcomeEmailsResponses, PostSendWelcomeEmailsErrors, ThrowOnError>({
