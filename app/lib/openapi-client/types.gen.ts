...
export type GetImagesData = {
    ...
    path?: never;
    query?: {
        type?: 'profile' | 'contractor' | 'order' | 'category' | 'chat' | 'contractorHeader';
    };
    url: '/images';
};
...
export type UpdateImageData = {
    body?: {
        imageType?: 'profile' | 'contractor' | 'order' | 'category' | 'chat' | 'contractorHeader';
        imageUrl?: string;
    };
    path: {
        id: string;
...
export type GetInfoInquiriesForOrderError = GetInfoInquiriesForOrderErrors[keyof GetInfoInquiriesForOrderErrors];
...
export type GetInfoInquiriesForOrderResponse = GetInfoInquiriesForOrderResponses[keyof GetInfoInquiriesForOrderResponses];
...
export type RespondToInfoInquiryError = RespondToInfoInquiryErrors[keyof RespondToInfoInquiryErrors];
...
export type RespondToInfoInquiryResponse = RespondToInfoInquiryResponses[keyof RespondToInfoInquiryResponses];
