import {
  getLandingPageAnalytics as getLandingPageAnalyticsApi,
  GetLandingPageAnalyticsResponse,
} from "../openapi-client";
...
const getLandingPageAnalytics = async (accessToken?: string) => {
  ...
  if (cached && Date.now() - cached.timestamp < CACHE_DURATION_MS) {
    return cached.data as GetLandingPageAnalyticsResponse;
  }
  ...
  return res.data as GetLandingPageAnalyticsResponse;
};
