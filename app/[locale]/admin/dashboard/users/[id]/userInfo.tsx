    ...
    <Card className="p-6">
      ...
      <Tabs defaultValue="contact" className="w-full">
        <TabsList className="grid w-full grid-cols-5 text-left">
          <TabsTrigger className="text-left" value="contact">
            Contact
          </TabsTrigger>
          <TabsTrigger className="text-left" value="address">
            Address
          </TabsTrigger>
          <TabsTrigger className="text-left" value="account">
            Account
          </TabsTrigger>
          <TabsTrigger className="text-left" value="preferences">
            Preferences
          </TabsTrigger>
          <TabsTrigger className="text-left" value="badges">
            Badges
          </TabsTrigger>
        </TabsList>
        ...
        <div className="mt-6 h-96 text-left">
          ...
          <TabsContent value="preferences">
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              />
              <InfoRow label="SMS" value={userData.smsPersmission} />
              <InfoRow
