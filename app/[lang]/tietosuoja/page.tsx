...
export default async function Page({ params: { lang } }: { params: { lang: AvailableLocale } }) {
  ...
  return (
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10 text-gray-800 dark:text-gray-100">
        ...
        <section>
          <h2 className="text-2xl font-semibold">{dict.privacy.dataControllerTitle}</h2>
          <p className="mt-2">{dict.privacy.dataControllerDescription}</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold">{dict.privacy.privacyPolicyTitle}</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold">{dict.privacy.cookiePolicyTitle}</h2>
          <p className="mt-2">{dict.privacy.cookiePolicyIntro}</p>
        </section>

        <section>
          <h3 className="text-xl font-semibold">{dict.privacy.cookieSection1Title}</h3>
          <p className="mt-2">{dict.privacy.cookieSection1Content}</p>
        </section>

        <section>
          <h3 className="text-xl font-semibold">{dict.privacy.cookieSection2Title}</h3>
          <ul className="list-disc list-inside mt-2 space-y-1">
        ...
        <section>
          <h3 className="text-xl font-semibold">{dict.privacy.cookieSection3Title}</h3>
          <p className="mt-2">{dict.privacy.cookieSection3Content}</p>
        </section>

        <section>
          <h3 className="text-xl font-semibold">{dict.privacy.cookieSection4Title}</h3>
