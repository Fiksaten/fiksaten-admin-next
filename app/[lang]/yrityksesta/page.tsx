  ...
  return (
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10 text-gray-800 dark:text-gray-100">
          <section className="flex flex-col items-center text-center space-y-6">
              <Badge className="bg-[#EBF5FF] rounded-full py-2 px-6" aria-label={dict.company.badge}>
          ...
          <section className="flex flex-col md:flex-row md:space-x-8">
              ...
              <div className="md:w-1/2 space-y-8 pt-10 md:pt-0" aria-labelledby="cities-heading">
                  <h4 id="cities-heading" className="sr-only">{dict.company.citiesHeading}</h4>
                  ...
                  {Object.entries(dict.company.cities).map(([key, city]) => (
                      ...
                      >
                          <h5 id={`city-${key}`} className="text-4xl font-extrabold">{city.name}</h5>
