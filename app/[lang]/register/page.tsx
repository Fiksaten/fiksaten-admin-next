...
export default async function Register({ params: { lang}, searchParams, }: { params: { lang: AvailableLocale }, searchParams: { type?: 'consumer' | 'contractor' }; }) {
  ...
  return (
      <div className="flex-grow flex flex-col lg:flex-row bg-white p-4 sm:p-8 lg:p-12 items-center justify-center">
          ...
          <div className="w-full lg:w-2/5 p-4 sm:p-8 lg:p-12">
              <RegisterForm dict={dict} type={searchParams.type ?? 'consumer'}/>
          </div>
      </div>
  );
}
