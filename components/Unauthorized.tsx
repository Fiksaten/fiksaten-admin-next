    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-black">
      <div className="bg-black flex flex-col p-8 shadow-md rounded-md text-center justify-center items-center">
        <h1 className="text-3xl font-bold mb-4">
          Oops! You&apos;re Trying to Sneak Into a Secret Club… But You&apos;re
          Not on the List.
        </h1>
        <p className="text-lg mb-6">
          Looks like you&apos;ve tried to access an exclusive area of the site.
          Unfortunately, only authorized agents, ninjas, or hackers are allowed
          beyond this point
        </p>
        <Image
          src={bouncer}
        ...
        <footer className="mt-6 text-gray-500">
          Don&apos;t worry, you&apos;re not the only one. We&apos;ve turned away
          1,043 nosy users today!
        </footer>
      </div>
    </div>
  );
