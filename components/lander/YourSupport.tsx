  ...
  <div className="w-full h-full relative">
    ...
    <div className="absolute inset-0 bg-black bg-opacity-40 text-white p-16">
      <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-start">
        Haluatko liittyä apulaiseksi?
      </h2>
      <p className="text-lg text-white mb-6">
        Fiksaten tarjoaa kätevän ja helpon tavan löytää asiakkaat läheltä sinua.
        Saat käyttöösi kaikki tarvittavat ohjelmisto-työkalut ja vapauden päättää omat työajat. Näet
        myös raportit tekemistä töistä ja tilityksistä.
      </p>
...
const TextContainer = () => (
  <div className="w-full h-full flex flex-col justify-start bg-[#FFEFFC] p-14 rounded-sm">
    <h1 className="text-4xl lg:text-6xl font-bold mb-4">
      Fiksaten on tukenasi
    </h1>
    <p className="text-base lg:text-lg text-gray-700 mb-6">
      Asiakaspalvelumme auttaa tarvittaessa missä tahansa kysymyksissä. Voit
      olla yhteydessä asiakaspalveluumme sähköpostitse tai kätevästi chatin
      välityksellä.
    </p>
    <p className="text-base lg:text-lg text-gray-700">
      Asiakaspalvelu palvelee arkisin 9-18 välisenä aikana.
    </p>
  </div>
);
