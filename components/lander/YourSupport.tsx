    ...
    <div className="w-full h-full relative">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-40 text-white p-16">
        <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-start">
          {t("lander.yourSupportSection.imageTitle")}
        </h2>
        <p className="text-lg hidden sm:block text-white mb-6">
          {t("lander.yourSupportSection.imageDescription")}
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full h-full flex flex-col justify-start bg-[#FFEFFC] p-14 rounded-sm">
      ...
      <p className="text-base lg:text-lg text-gray-700 mb-6">
        {t("lander.yourSupportSection.description")}
      </p>
      <p className="text-base lg:text-lg text-gray-700">
        {t("lander.yourSupportSection.additionalDescription")}
      </p>
      <Link href="/register?type=contractor">
        ...
        >
          {t("lander.yourSupportSection.actionPrimary")}
        </Button>
      </Link>
    </div>
  );
